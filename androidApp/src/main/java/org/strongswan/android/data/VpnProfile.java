...
public class VpnProfile implements Cloneable {
    ...
    private IPRangeSet allowedIpsSet;

    public IPRangeSet getAllowedIpsSet() {
        return allowedIpsSet;
    }

    public void setAllowedIpsSet(IPRangeSet allowedIpsSet) {
        this.allowedIpsSet = allowedIpsSet;
    }
