...
import com.runvpn.app.android.vpn.ikev2.Ikev2VpnService;
...
public class VpnStateService extends Service
{
	...
	*/
	...
	public void disconnect()
	{
		...
		Intent intent = new Intent(context, Ikev2VpnService.class);
	...
	private static class RetryHandler extends Handler {
		...
		public void handleMessage(Message msg)
		{
			...
			try {
				if (mService == null || mService.get().mRetryTimeout <= 0) {
					return;
				}
