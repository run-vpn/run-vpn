...
public class VPNLaunchHelper {
    ...
    public static void startOpenVpn(VpnProfile startprofile, Context context, List<String> excludedApps, int splitMode, String dnsServerIp, boolean allowLanConnection, long timeToShutdownInMillis) {
        Intent startVPN = startprofile.prepareStartService(context, excludedApps, splitMode, dnsServerIp, allowLanConnection, timeToShutdownInMillis);
        if (startVPN != null) {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O)
                //noinspection NewApi
                context.startForegroundService(startVPN);
