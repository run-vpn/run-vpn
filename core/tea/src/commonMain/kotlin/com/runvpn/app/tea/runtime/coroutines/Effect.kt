package com.runvpn.app.tea.runtime.coroutines
...
interface Effect<Dependencies, out Message> {
    ...
    companion object {
        ...
        operator fun <Dependencies, Message> invoke(action: Action<Dependencies, Message>) =
            object : Effect<Dependencies, Message> {
